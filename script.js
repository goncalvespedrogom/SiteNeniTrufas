...
addressInput.addEventListener("input", function(event){        /* CAMPO DE ENDEREÇO NÃO PREENCHIDO */
...
/* ENVIAR O PEDIDO PARA A API WPPWEB */
...
function checkRestaurantOpen (){
    ...
    return hora >= 11 && hora < 22; //true (aberto)
}
